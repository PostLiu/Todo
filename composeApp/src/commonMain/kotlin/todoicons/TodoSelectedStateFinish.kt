...
public val TodoIcons.TodoSelectedStateFinish: ImageVector
    get() {
        if (_todoSelectedStateFinish != null) {
            return _todoSelectedStateFinish!!
        }
        _todoSelectedStateFinish = Builder(name = "TodoSelectedStateFinish", defaultWidth = 24.0.dp,
...
private var _todoSelectedStateFinish: ImageVector? = null
